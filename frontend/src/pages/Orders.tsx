...
import ModalContainer from '../components/ModalContainer'; // import ModalContainer
import useModal from '../hooks/useModal'; // import useModal
import Modal from '../components/Modals'; // import Modal
...
const Orders: React.FC = () => {
  ...
  const handleAddOrder = () => {
    ...
    close(); // Close the modal after adding the order
  };
          ...
          <Modal text={'Add New Order'} type={modalType} handleClose={close}>
            ...
            <div className="mt-4 flex justify-end space-x-2">
              <button
                ...
                onClick={close} // Close modal without saving
              >
                Cancel
              </button>
              <button
                className="bg-primary-500 hover:bg-primary-600 text-white font-bold py-2 px-4 rounded"
                onClick={handleAddOrder} // Save new order and close modal
              >
                Add Order
              </button>
            </div>
